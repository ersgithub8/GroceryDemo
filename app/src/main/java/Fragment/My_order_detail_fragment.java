...
public class My_order_detail_fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       // Toast.makeText(getActivity(), getuserid, Toast.LENGTH_SHORT).show();
        ...
        SharedPreferences prefs = getActivity().getSharedPreferences("5", MODE_PRIVATE);
        u = prefs.getString("5", "No name defined");
    ...
    private void showDeleteDialog() {
        ...
        alertDialog.setPositiveButton(getResources().getString(R.string.yes), new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                // check internet connection
                if (ConnectivityReceiver.isConnected()) {
                    makeDeleteOrderRequest(sale_id);
                }
...
//                    Toast.makeText(getActivity(), getResources().getString(R.string.no_rcord_found), Toast.LENGTH_SHORT).show();
     ...
     */
    private void makeDeleteOrderRequest(String sale_id) {
