...
public class my_last_order_adapter extends RecyclerView.Adapter<my_last_order_adapter.MyViewHolder> {
    ...
    public my_last_order_adapter(Context context, List<My_Pending_order_model> modemodelList, final Fragment currentFragment) {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public TextView tv_pending_date, tv_pending_time,deliverymethod_tv ,tv_confirm_date,deliver_boy_name,delivery_boy_phone,deliver_boy_vehical_no, tv_confirm_time, tv_delevered_date, tv_delevered_time, tv_cancel_date, tv_cancel_time;
        public View view1, view2, view3, view4, view5, view6,view7,view8;
        public RelativeLayout relative_background;
        public ImageView Confirm, Out_For_Deliverde, Delivered,Picked_image,cancel_img,pending_img;
        public LinearLayout linearLayout12;
        CardView cardView;
        public TextView tv_methid1,yourorder_tv;
        ...
        public MyViewHolder(View view) {
            ...
            deliver_boy_name=(TextView)view.findViewById(R.id.delivery_boy_name);
            delivery_boy_phone=(TextView)view.findViewById(R.id.delivery_boy_phone);
            deliver_boy_vehical_no=(TextView)view.findViewById(R.id.delivery_boy_vehical_no);
            yourorder_tv=(TextView)view.findViewById(R.id.yourorder_tv);
            deliverymethod_tv=(TextView)view.findViewById(R.id.deliverymethod_tv);
...
//            tv_cancel_time = (TextView) view.findViewById(R.id.cancel_time);
            ...
            view7 = (View) view.findViewById(R.id.view7);
            view8 = (View) view.findViewById(R.id.view8);
            ...
            Picked_image = (ImageView)view.findViewById(R.id.Picked_image);
            cancel_img = (ImageView) view.findViewById(R.id.cancal2_image);
            pending_img = (ImageView) view.findViewById(R.id.pending_img);

        }
    }

    public my_last_order_adapter(List<My_Pending_order_model> modelList) {
        this.modelList = modelList;
    }

    @Override
    public my_last_order_adapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_last_oder, parent, false);
        context = parent.getContext();
        return new my_last_order_adapter.MyViewHolder(itemView);
    }
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        ...
        holder.deliver_boy_name.setText("no");
        holder.delivery_boy_phone.setText("no");
        holder.deliver_boy_vehical_no.setText("0");
        holder.deliverymethod_tv.setText(mList.getDelivery_method());
...
//        editor.putString("rating","Null");
        ...
        if (mList.getStatus().equals("0")) {
            ...
            holder.pending_img.setImageResource(R.color.green);
            ...
            holder.view7.setBackgroundColor(context.getResources().getColor(R.color.green));
            holder.pending_img.setImageResource(R.color.green);
            holder.Confirm.setImageResource(R.color.green);
            holder.Out_For_Deliverde.setImageResource(R.color.green);
            holder.Picked_image.setImageResource(R.color.green);
            holder.tv_status.setText("Picked");
            holder.relativetextstatus.setText("Picked");
            ...
            holder.view5.setBackgroundColor(context.getResources().getColor(R.color.green));
            holder.view7.setBackgroundColor(context.getResources().getColor(R.color.green));
            holder.view8.setBackgroundColor(context.getResources().getColor(R.color.green));
            ...
            SharedPreferences editors = context.getSharedPreferences("rating_store",MODE_PRIVATE);

            String israted = editors.getString("rating","null");
            if (israted.equals("null")){
            new AlertDialog.Builder(context)
                    .setIcon(R.drawable.alert)
                    .setTitle("Rating Alert")
                    .setMessage("Please Rate your Last order")
                    .setPositiveButton("Go For Rating", new DialogInterface.OnClickListener()
                    {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            intent.putExtra("store_id",mList.getNew_store_id());
                            intent.putExtra("db_id",mList.getAssign_to());
...
//            //holder.linearLayout.setVisibility(View.GONE);
//            holder.cancel_img.setImageResource(R.color.green);
