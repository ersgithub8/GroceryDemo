...
public class View_address_adapter extends RecyclerSwipeAdapter<View_address_adapter.MyViewHolder> {

    private static String TAG = Delivery_get_address_adapter.class.getSimpleName();
    View_address_adapter view_address_adapter;
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        public TextView tv_address, tv_name, tv_phone, tv_charges,et_address;
        ...
        public MyViewHolder(View view) {
            ...
            et_address=(TextView)view.findViewById(R.id.address_et);
            try{
                cross.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        final ProgressDialog alertDialog = new ProgressDialog(context);
                        alertDialog.setMessage("Your Address is removing");
                        alertDialog.show();
//                        ((Activity) context).getWindow().setFlags(WindowManager.LayoutParams.FLAG_NOT_TOUCHABLE,
//                                WindowManager.LayoutParams.FLAG_NOT_TOUCHABLE);
                        try{
                            String location_id = modelList.get(getAdapterPosition()).getLocation_id();
                            //Toast.makeText(context, location_id, Toast.LENGTH_SHORT).show();


                            String tag_json_obj = "json_delete_order_location";
                            ...
                            CustomVolleyJsonRequest jsonObjReq = new CustomVolleyJsonRequest(Request.Method.POST,
                                    BaseURL.DELETE_location, params, new Response.Listener<JSONObject>() {
...
//                                    Toast.makeText(context,"Your Address is deleted" , Toast.LENGTH_SHORT).show();
    ...
    public View_address_adapter(List<Delivery_address_model> modelList) {
        this.modelList = modelList;
    }

    @Override
    public View_address_adapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.row_delivery_time_rv_test, parent, false);

        context = parent.getContext();

        return new View_address_adapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(final View_address_adapter.MyViewHolder holder, final int position) {
