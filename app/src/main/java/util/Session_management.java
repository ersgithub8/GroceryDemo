...
import static Config.BaseURL.APARTMENT_ID;
import static Config.BaseURL.AREA_ID;
import static Config.BaseURL.IS_LOGIN;
import static Config.BaseURL.KEY_APARTMENT_NAME;
import static Config.BaseURL.KEY_AREA_NAME;
...
public class Session_management {
    ...
    public HashMap<String, String> getUserDetails() {
        ...
        user.put(KEY_AREA_NAME, prefs.getString(KEY_AREA_NAME, null));
        user.put(KEY_APARTMENT_NAME, prefs.getString(KEY_APARTMENT_NAME, null));
        user.put(AREA_ID, prefs.getString(AREA_ID, null));
        user.put(APARTMENT_ID, prefs.getString(APARTMENT_ID, null));
    ...
    public void updateArea(String area_name, String area_id) {
        editor.putString(KEY_AREA_NAME, area_name);
        editor.putString(AREA_ID, area_id);

        editor.apply();
    }
    public void updateApartment(String apartment_name, String apartment_id) {
        editor.putString(KEY_APARTMENT_NAME, apartment_name);
