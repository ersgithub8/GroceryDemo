...
public class MyOrderDetail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_cancle.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                 getCancelReason= Cancel_reason.getText().toString();
                if (TextUtils.isEmpty(getCancelReason))
                {       Toast.makeText(MyOrderDetail.this, "Please Enter Reason", Toast.LENGTH_SHORT).show();
    ...
    private void makeDeleteOrderRequest(String sale_id, String user_id) {
        ...
        params.put("sale_id", sale_id);
        params.put("status", "5");
        params.put("cancel_person_id",userid);
        params.put("cancelfrom","Customer");
        params.put("reason",getCancelReason);
